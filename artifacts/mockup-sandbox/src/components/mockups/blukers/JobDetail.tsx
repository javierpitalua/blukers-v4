...
import { jobs, candidates, pipelineStages } from "./_shared/mockData";
import type { Candidate } from "./_shared/mockData";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
    ...
    <AppLayout activePage="jobs">
      <div className="max-w-6xl mx-auto space-y-6">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="/__mockup/preview/blukers/Jobs">
                Jobs
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
          ...
          <div className="flex items-center justify-between">
            <TabsList>
              <TabsTrigger value="candidates">
                Candidates ({appliedCandidates.length})
              </TabsTrigger>
                        ...
                        filteredCandidates.map((candidate) => (
                          ...
                          >
                            <td className="px-5 py-3.5">
                              <div className="flex items-center gap-3">
                                <Avatar className="w-9 h-9">
                                  <AvatarFallback
                                    className={`text-xs font-semibold ${candidate.avatarColor}`}
                                  >
                                    {candidate.initials}
                                  </AvatarFallback>
                                </Avatar>
                                <div>
                                  <a
                                    href="/__mockup/preview/blukers/CandidateDetail"
                            ...
                            <td className="px-5 py-3.5">
                              <Badge
                                variant="secondary"
                                className={candidate.stageColor}
                              >
                                {candidate.stage}
                              </Badge>
                            </td>
              ...
              <CardContent className="pt-6 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    {job.description} This role involves working on large-scale
                    commercial construction projects, ensuring all electrical
                    systems meet local and national codes. The ideal candidate
                    will have experience with commercial wiring, panel
                    installation, and team supervision.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start gap-2">
                      ...
                      Master Electrician License or equivalent
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
                      Minimum 8 years of commercial electrical experience
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
                      Proficiency in reading blueprints and electrical schematics
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 shrink-0" />
                      Team leadership and supervisory experience preferred
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-blue-500 mt-0.5 shrink-0" />
                      Paid time off and company vehicle
                    </li>
                  </ul>
                </div>
              </CardContent>
